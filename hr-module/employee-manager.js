...
function edit(existing){
 const e=existing||{id:crypto.randomUUID(),name:'',designation:'',branch:HRCore.branches[0],joined:HRCore.today(),email:'',mobile:'',active:true,weeklyOff:'Sunday',shiftIn:'10:00',shiftOut:'20:30',lateGrace:15};
